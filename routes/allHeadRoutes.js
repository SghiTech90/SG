...
const { buildingAllHEAD, CrfMPRreportAllHEAD, DepositAllHead, DPDCAllHead, MLAAllHEAD, MPAllHEAD, NABARDAllHEAD, ROADAllHEAD, GAT_A_AllHEAD, GAT_D_AllHEAD, GRAMVIKAS_AllHEAD } = require('../controllers/allHeadController');
